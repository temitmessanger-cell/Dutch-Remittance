...
/// only these 10 countries are confirmed live payout destinations on
/// this Eversend account; the rest are shown for completeness but
/// flagged so the UI can be upfront that a corridor isn't live yet
...
const List<AfricanCountryInfo> kAfricanCountries = [
  ...
  AfricanCountryInfo(countryName: 'Gabon', countryCode: 'GA', currencyCode: 'XAF', currencyName: 'Central African CFA Franc', flagEmoji: '🇬🇦', hasLiveRate: false),
  ...
  AfricanCountryInfo(countryName: 'Equatorial Guinea', countryCode: 'GQ', currencyCode: 'XAF', currencyName: 'Central African CFA Franc', flagEmoji: '🇬🇶', hasLiveRate: false),
  AfricanCountryInfo(countryName: 'Mali', countryCode: 'ML', currencyCode: 'XOF', currencyName: 'West African CFA Franc', flagEmoji: '🇲🇱', hasLiveRate: false),
  ...
  AfricanCountryInfo(countryName: 'Togo', countryCode: 'TG', currencyCode: 'XOF', currencyName: 'West African CFA Franc', flagEmoji: '🇹🇬', hasLiveRate: false),
  AfricanCountryInfo(countryName: 'Benin', countryCode: 'BJ', currencyCode: 'XOF', currencyName: 'West African CFA Franc', flagEmoji: '🇧🇯', hasLiveRate: false),
  AfricanCountryInfo(countryName: 'Niger', countryCode: 'NE', currencyCode: 'XOF', currencyName: 'West African CFA Franc', flagEmoji: '🇳🇪', hasLiveRate: false),
  AfricanCountryInfo(countryName: 'Burkina Faso', countryCode: 'BF', currencyCode: 'XOF', currencyName: 'West African CFA Franc', flagEmoji: '🇧🇫', hasLiveRate: false),
  AfricanCountryInfo(countryName: 'Guinea-Bissau', countryCode: 'GW', currencyCode: 'XOF', currencyName: 'West African CFA Franc', flagEmoji: '🇬🇼', hasLiveRate: false),
  ...
  AfricanCountryInfo(countryName: 'Chad', countryCode: 'TD', currencyCode: 'XAF', currencyName: 'Central African CFA Franc', flagEmoji: '🇹🇩', hasLiveRate: false),
