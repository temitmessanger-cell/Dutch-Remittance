      ...
      child: ConstrainedBox(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              // Small branded header — the app's own confirmation is
              // the one place Dutch Remit branding genuinely can
              // appear on a transaction (no payment API lets a sender
              // control the SMS text a recipient's own mobile network
              // shows them — that's generated by the telco itself,
              // industry-wide). Previously only the downloadable
              // receipt text said "Dutch Remit" anywhere; the visible
              // on-screen dialog never did.
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text('D', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w800, color: Colors.white)),
                  ),
