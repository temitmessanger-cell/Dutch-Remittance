          ...
          Expanded(
            child: Container(
                ...
                child: FutureBuilder<Map<String, dynamic>>(
                    future: getData(urlPath: "/Dutch Remit/app"),
                                    ...
                                    children: [
                                      ...
                                      RawMaterialButton(
                                        ...
                                        constraints: BoxConstraints(
                                            ...
                                            maxHeight: 64.0),
                                        child: Image.network(
                                            '${ApiConstants.baseUrl}/dist/images/Dutch Remit_images/attributions/${snapshot.data!['attributions'][index]['avatar']}'),
                                      ...
                                      itemBuilder: (_, socialIndex) =>
                                          RawMaterialButton(
                                            ...
                                            constraints: BoxConstraints(
                                                ...
                                                maxHeight: 48.0),
                                            child: Image.network(
                                                '${ApiConstants.baseUrl}/dist/images/DutchRemittancecodes/social_icons/${snapshot.data!['attributions'][index]['socials'][socialIndex]['avatar']}'),
