        ...
        children: [
          Expanded(
            ...
            child: FutureBuilder<Map<String, dynamic>>(
                future: getData(urlPath:  "/about/DutchRemittancecodes"),
                        ...
                        snapshot.data!['socialNetworkingProfiles']
                            .map<Widget>((social) => RawMaterialButton(
                                  ...
                                  constraints: BoxConstraints(
                                      ...
                                      maxHeight: 64.0),
                                  child: Image.network(
                                        '${ApiConstants.baseUrl}/dist/images/DutchRemittancecodes/social_icons/colorable/${social['avatar']}',
                                      ),
                          ...
                          CircleAvatar(
                              ...
                              child: ClipOval(
                                child: AspectRatio(
                                  aspectRatio: 1.0 / 1.0,
                                  child: Image.network(
                                    '${ApiConstants.baseUrl}/dist/images/Dutch Remit_images/attributions/${snapshot.data!['avatar']}',
                                    height: 120,
                                    width: 120,
                                    fit: BoxFit.contain,
                                  ),
