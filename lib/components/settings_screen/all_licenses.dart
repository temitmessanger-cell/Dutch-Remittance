...
import 'package:dutch_remit/components/settings_screen/license_data.dart';
    ...
    return Scaffold(
        ...
        body: Column(children: [
          Wrap(
            ...
            spacing: 6.18,
            children: [
              DutchRemitWordmark(fontSize: 22),
              Text('1.0.0',style: TextStyle(color: AppColors.ink)),
              FlutterLogo(
                size: 36,
              ),
              Text('Powered by Flutter',style: TextStyle(color: AppColors.ink),),
            ],
          ),
          SizedBox(
            height: 16,
